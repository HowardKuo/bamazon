DROP DATABASE IF EXISTS bamazan_DB;
...
INSERT INTO products (product_name,department_name, price, stock_quantity) values('Vacuum','Cleaning',79.99,3);
...
INSERT INTO products (product_name,department_name, price, stock_quantity) values('The Infinity Gauntlet','???',999999.99,1);